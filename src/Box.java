...
public class Box {
    ...
    public static void main(String[] args) {
        ...
        box.printBox();
            ...
            System.out.println("Punkt (10,10), szerokość 20, wysokość 50");
            box = new Box(new Point(10,10), 2-, 5);
            box.printBox
    ...
    public static void main(String[] args) {
        int a;
        System.out.println(a);          //a nie dostaje wartości domyślnej, nie możemy tak zrobić
    }
}
*/